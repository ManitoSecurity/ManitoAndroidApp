...
/**
 * This class returns a dialog. It lists any paired devices and
...
public class BTList {
    ...
    protected ArrayAdapter<String> makeList(BluetoothAdapter mBT, Context context) {
        ...
        pairedDevicesArrayAdapter =
                new ArrayAdapter<String>(mContext, R.layout.device_name);
